...
<head>
    ...
    <link rel="stylesheet" href="CSS/garcon.css">
...
<div class="botao-container" id="botao-container">
    ...
    foreach ($data as $row) {
        echo '<button class="btndivs" onclick="escondediv(' . $row['codigo'] . ')"> <img src="imgs/comer.png" style="height: 130px; width: 130px;"><p style="margin:5px 0 5px 0">' . $row['descricao'] . '</p></button>';
    }
